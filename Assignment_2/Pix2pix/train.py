...
# from FCN_network_U_net import FullyConvNetwork
# from U_net_model import UNet
from FCN_network_res16 import FullyConvNetwork
...
def main():
    ...
    train_dataset = MapsDataset(list_file="train_list.txt")
    val_dataset = MapsDataset(list_file="val_list.txt")
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 20 == 0:
            ...
            torch.save(
                model.state_dict(), f"checkpoints/pix2pix_model_epoch_{epoch + 1}.pth"
            )
